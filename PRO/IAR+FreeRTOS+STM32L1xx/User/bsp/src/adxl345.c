...
adxl345_int_result_t adxl345_act_freefall_int_process(void)
{
	...
	//{
		...
		{
			adxl345_int_result.adxl345_result.adxl345_status = ADXL345_ERR;
                ...
                if(interrupt_reg_source.interrupt_reg_bits.activity)//判断是否activity中断
		{
			...
			if(adxl345_status == ADXL345_ERR)
			{
				...
				return adxl345_int_result;
                        ...
                        adxl345_int_result.adxl345_int_type = activity;
			adxl345_int_result.adxl345_result = getAcceleration();
			return adxl345_int_result;
		}
                else if(interrupt_reg_source.interrupt_reg_bits.free_fall)//判断是否freefall中断
		{
			...
			if(adxl345_status == ADXL345_ERR)
			{
				...
				return adxl345_int_result;
                        ...
                        adxl345_int_result.adxl345_int_type = free_fall;
			adxl345_int_result.adxl345_result = getAcceleration();
			return adxl345_int_result;			
		}
		else
