...
nt3h1101_id_t nt3h1101_get_id(void)
{
	...
	nt3h1101_id.id_bytes[1] = 0x3A; //:
	nt3h1101_id.id_bytes[2] = nt3h1101_result.block_bytes[1];
	nt3h1101_id.id_bytes[3] = nt3h1101_result.block_bytes[2];
	nt3h1101_id.id_bytes[4] = nt3h1101_result.block_bytes[3];
	nt3h1101_id.id_bytes[5] = 0x3A; //:
	nt3h1101_id.id_bytes[6] = nt3h1101_result.block_bytes[4];
	nt3h1101_id.id_bytes[7] = nt3h1101_result.block_bytes[5];
	nt3h1101_id.id_bytes[8] = nt3h1101_result.block_bytes[6];
